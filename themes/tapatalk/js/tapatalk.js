    ...
    $.cctapatalk = (function(){
        ...
        return {
            ...
            initialize: function(){
                ...
                trayData += '<span id="cometchat_edit">'+language[97]+'</span>';
                trayData += '</div>';

                var modules = '<div class="cometchat_modules_container">';
                ...
                if(settings.showOnlineTab==1){
                    usertab = '<span id="cometchat_userstab" class="cometchat_tab"><span id="cometchat_userstab_icon"></span><span id="cometchat_userstab_text">'+language[96]+' ('+jqcc.tapatalk.updateMessageCount(1)+')</span></span>';
                ...
                if(extlength>0){
                    for(var i = 0; i<extlength; i++){
                        ...
                        if(typeof ($[name])=='object' && name!='ccjabber'){
                            $[name].init();
                        }
                    }
                }
            ...
            buddyList: function(item){
                ...
                var deletePopup = '<div class="conf_popup"><div><p>'+language[104]+'<label>'+language[100]+'<input type="checkbox" name="donotShow" id="donotShow" ></label></p><span class = "conf_button">'+language[103]+'</span><span class = "conf_button" style="right:75px;">'+language[101]+'</span></div></div>';
                ...
                if(document.getElementById('cometchat_userslist')){
                    if(buddylisttempavatar!=''){
                        ...
                        $('#cometchat_userslist').html('<div class="cometchat_nofriends"><div style="margin: 10px;">'+language[106]+'</div></div>');
                    }
                }
                ...
                //$('#cometchat_userstab_text').html(language[96]+' ('+(onlineNumber+jqcc.cometchat.getThemeVariable('jabberOnlineNumber'))+')');
           ...
           createChatboxData: function(id, name, status, message, avatar, link, silent, tryOldMessages){
                        ...
                        for(var i = 0; i<pluginslength; i++){
                            ...
                            if(typeof ($[name])=='object'){
                                if(settings.plugins[i]=='avchat'){
                                    ...
                                    smiliehtml = '<div id="cometchat_pluginscontainer"><div class="cometchat_pluginsicon cometchat_smilies" name="'+name+'" to="'+id+'" chatroommode="0" title="'+$[name].getTitle()+'"></div><div class="cometchat_pluginsicon cometchat_filetransfer" name="ccfiletransfer" to="'+id+'" chatroommode="0" title="Send a Picture"></div></div>';
                                } else if(settings.plugins[i]!='chattime' && settings.plugins[i]!='block' && settings.plugins[i]!='filetransfer' && settings.plugins[i]!='deleteconversation'){
                ...
                var blockPopup = '';
                var userisOffline = '<div class = "cometchat_userofflineMessage" id="cometchat_userofflineMessage_'+id+'">'+language[98]+'<span class = "closeOffline" id="close_offline_"'+id+'" onclick="jqcc.tapatalk.closeOffline('+id+')">x</span></div>';
                if(status != 'blocked') {
                    var banNew = '<div id="cometchat_usercontrol"><span id="cometchat_ban_'+id+'" class="cc_ban" onclick="jqcc.tapatalk.blockinit('+id+')"></span><span id="cometchat_newlink" onclick="jqcc.tapatalk.startAvchat('+id+')"></span></div>';
                    blockPopup = '<div id = "conf_block_'+id+'" class="conf_block"><div><p id="blockText">'+language[99]+'<label>'+language[100]+'<input type="checkbox" name="donotShowBlock" id="donotShowBlock" ></label></p><span class="conf_button_block">'+language[103]+'</span><span class="conf_button_block" style="right:75px;">'+language[101]+'</span></div></div>';
                }else {
                    var banNew = '<div id="cometchat_usercontrol"><span id="cometchat_ban_'+id+'" class="cc_unban" onclick="jqcc.tapatalk.unblockinit('+id+')">Unblock</span><span id="cometchat_newlink" onclick="jqcc.tapatalk.startAvchat('+id+')"></span></div>';

                    blockPopup = '<div id = "conf_block_'+id+'" class="conf_block"><div><p id="blockText">'+language[102]+'<label>'+language[100]+'<input type="checkbox" name="donotShowBlock" id="donotShowBlock" ></label></p><span class="conf_button_block">'+language[103]+'</span><span class="conf_button_block" style="right:75px;">'+language[101]+'</span></div></div>';
                }



                var prepend = '<div class=\"cometchat_prependMessages\" onclick\="jqcc.tapatalk.prependMessagesInit('+id+')\" id = \"cometchat_prependMessages_'+id+'\">'+language[83]+'</div>';

                $("<div/>").attr("id", "cometchat_user_"+id+"_popup").addClass("cometchat_tabpopup").css('display', 'none').html('<div class="cometchat_tabtitle">'+isMobile+'<div class="cometchat_userscontentdot101 cometchat_'+status+' cometchat_floatL" style="top:5px;"></div><div class="cometchat_name" title="'+longname+'">'+startlink+longname+endlink+'<span id="cometchat_typing_'+id+'" class="cometchat_typing"></span></div><div id="cometchat_closebox_'+id+'" data-title="'+language[74]+'" class="cometchat_closebox cometchat_floatR cometchat_tooltip">×</div><div class="cometchat_plugins_dropdown cometchat_floatR"><div class="cometchat_plugins_dropdown_icon cometchat_tooltip" id="cometchat_plugins_dropdown_icon_'+id+'" data-title="'+language[73]+'"></div><div class="cometchat_popup_plugins">'+pluginshtml+'</div></div>'+''+'</div><div class="cometchat_tabsubtitle cometchat_tabcontent"><div class="cometchat_message">'+banNew+'</div>'+blockPopup+'<div class="cometchat_tabcontenttext" id="cometchat_tabcontenttext_'+id+'" onscroll="jqcc.'+settings.theme+'.chatScroll('+id+');">'+userisOffline+prepend+'</div><div class="cometchat_tabcontentinput"><textarea class="cometchat_textarea" placeholder="'+language[55]+'"></textarea>'+smiliehtml+'</div><div style="clear:both"></div></div>').appendTo($("#cometchat"));
                ...
                cometchat_user_popup.find('.cometchat_plugins_dropdownlist, .cometchat_smilies, .cometchat_filetransfer').click(function(){
                ...
                if(!showavchat){
                    cometchat_user_popup.find('#cometchat_newlink').hide();
                }
            ...
            addMessages: function(item){
                ...
                $.each(item, function(i, incoming){
                    ...
                    jqcc[settings.theme].groupbyDate(incoming.from);
                    if(incoming.self!=1&&settings.messageBeep==1){
                        if($.cookie(settings.cookiePrefix+"sound")&&$.cookie(settings.cookiePrefix+"sound")=='true'){
                        }else{
                            if(incoming.old!=1){
                ...
                if(jqcc.cometchat.getThemeVariable('loggedout')==0){
                    ...
                    if(cc_state!=null){
                        ...
                        if(cc_states[4]==0&&jqcc.cometchat.getThemeVariable('offline')==1){
                            ...
                            //$('#cometchat_userstab_text').html(language[96]);
                            $('#cometchat_userstab_text').html(language[96]+'('+jqcc.tapatalk.updateMessageCount(1)+')');
            ...
            optionsButton: function(){
                ...
                cometchat_optionsbutton.click(function(){
                    if(jqcc.cometchat.getThemeVariable('loggedout')==0){
                        if(jqcc.cometchat.getThemeVariable('offline')==1){
                            jqcc.cometchat.setThemeVariable('offline', 0);
                            $('#cometchat_userstab_text').html(language[96]+' ('+jqcc.cometchat.getThemeVariable('lastOnlineNumber')+')');
                            jqcc.cometchat.chatHeartbeat(1);
            ...
            deleteCommit: function(id){
                controlparameters = {'to':id,'chatroommode':'0'};
                jqcc['ccclearconversation'].init(controlparameters);
            ...
            blockCommit:function(id){
                ...
                controlparameters = {'to':id,'chatroommode':'0'};
                jqcc['ccblock'].init(controlparameters);
                $('div#conf_block_'+id).fadeOut('fast');
                ...
                $("#cometchat_userlist_"+id).find('span.cometchat_userscontentdot')
                                ...
                                .removeClass("cometchat_offline")
                                .removeClass("cometchat_away")
                                .addClass("cometchat_blocked");
                jqcc.cometchat.setThemeArray('buddylistStatus', id, 'blocked');
            ...
            unblockCommit:function(id){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('div#conf_block_'+id).fadeOut('fast');
                        $('div#conf_block_'+id).find('#blockText').html(language[99]+'<label>'+language[83]+'<input type="checkbox" name="donotShowBlock" id="donotShowBlock" ></label>');
            ...
            startAvchat:function(id){
                controlparameters = {'to':id,'chatroommode':'0'};
                jqcc['ccavchat'].init(controlparameters);
            },
            ...
            prependMessages:function(item,boxid){
                ...
                $.each(item, function(i, incoming){
                    ...
                    var msg = '';
                    if(parseInt(incoming.self)==1){
                        msg = '<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage" id="cometchat_message_'+incoming.id+'"><div class="cometchat_chatboxmessagecontent cometchat_self cometchat_floatR" title="'+sentdata+'">'+message+'</div><div class="selfMsgArrow"><div class="after"></div></div></div>';
                    }else{
                        msg = '<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage" id="cometchat_message_'+incoming.id+'">'+selfstyleAvatar+'<div class="cometchat_chatboxmessagecontent cometchat_floatL" title="'+sentdata+'">'+message+'</div><div class="msgArrow"><div class="after"></div></div></div></div>';
                    }
                    oldMessages+=msg;
                });
                ...
                if(count == 0){
                    $('#cometchat_prependMessages_'+boxid).text(language[84]);
                } else {
                    $('#cometchat_prependMessages_'+boxid).text(language[83]);
                }
                jqcc[settings.theme].groupbyDate(id);
            },
            groupbyDate: function(id){
