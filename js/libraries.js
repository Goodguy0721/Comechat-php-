					...
					if(name != 'passwordBox'){
						if(!$('.cometchat_windows').hasClass('visible') && !$('.cometchat_container').hasClass('visible')){
							if($("#cometchat_righttab").width()-cometchat_container.width() <= 400 && $('#cometchat_righttab').width()!=$(window).width()){
								...
								$("#cometchat_righttab").find(".cometchat_textarea").animate({'width':$("#cometchat_righttab").width() - (reducesize + 145) + 'px'},"fast");
								setTimeout(function(){
									if(rtl == 1){
						...
						if(rtl == 1){
							cometchat_container.css({right:'100%'}).animate({"right":animatewidth}, "fast").addClass('visible');
						}else{
							cometchat_container.css({left:left}).animate({"left":animatewidth}, "fast").addClass('visible');
						}
					}else{
					...
					if(id == 'blocks'){
						...
						if(name != 'passwordBox'){
							if($("#cometchat_righttab").width()+cometchat_container.width() >= ($(window).width()-2) && $('#cometchat_leftbar').css('left') != 'auto'){
								if(windowwidth == cometchat_container.width()){
