...
$themeSettings['bar_background'] = setColorValue('bar_background','#439fe0',$parentColor);
...
$themeSettings['bar_border'] = setColorValue('bar_border','#439fe0',$parentColor);
...
$themeSettings['tab_background'] = setColorValue('tab_background','#F6F6F6',$parentColor);
$themeSettings['tab_color'] = setColorValue('tab_color','#111111',$parentColor);
$themeSettings['tab_border'] = setColorValue('tab_border','#666F78',$parentColor);
...
$themeSettings['tab_color_self'] = setColorValue('tab_color_self','#fff',$parentColor);
...
$themeSettings['tab_title_background'] = setColorValue('tab_title_background','#439FE0',$parentColor);
$themeSettings['tab_title_gradient_start'] = setColorValue('tab_title_gradient_start','#439FE0',$parentColor);
$themeSettings['tab_title_gradient_center'] = setColorValue('tab_title_gradient_center','#439FE0',$parentColor);
$themeSettings['tab_title_gradient_end'] = setColorValue('tab_title_gradient_end','#439FE0',$parentColor);
$themeSettings['tab_title_border'] = setColorValue('tab_title_border','#439FE0',$parentColor);
...
$themeSettings['tab_border_light'] = setColorValue('tab_border_light','#DADADB',$parentColor);
