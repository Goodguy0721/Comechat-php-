...
if (file_exists(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."lang.php")) {
    include_once(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."lang.php");
}
    ...
    jqcc.extend(
        jqcc.synergy, {
            jabberInit: function() {
                ...
                $('#cometchat_userstab_popup').prepend('<div class="cometchat_tabsubtitle2" id="jabber_login"><img src="extensions/jabber/jabber_dark.png"  style="vertical-align:middle; position: relative;top: 5px;"> </img><span style="vertical-align: middle;">' + ccjabber.login + '</span></div>');
                $('#jabber_login').unbind('click');
                $('#jabber_login').bind('click', function() {
                    jqcc.ccjabber.login(caller);
                });
            ...
            jabberLogout: function() {
                ...
                var hash = '';
                $('#jabber_login').html('<img src="extensions/jabber/jabber_dark.png" style="vertical-align:middle; position: relative;top: 5px;"> </img><span style="vertical-align: middle;">' + ccjabber.login + '</span>');
            ...
            getRecentDataAjaxSuccess:  function(data , id , originalid) {
                ...
                $.each(data, function(id, message) {
                    ...
                    if (message.type == 'sent') {
                        ...
                        var avatarUrl = ccjabber.server+session+'?action=displayAvatar&userId='+message.from;
                        fromavatar = '<img class="cometchat_userscontentavatarsmall" src="'+avatarUrl+'">';
