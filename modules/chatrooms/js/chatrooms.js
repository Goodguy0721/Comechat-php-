    ...
    crvariables : {themename: '<?php echo $theme;?>',
                ...
                if ((event.keyCode == 13 && event.shiftKey == 0) || force == 1 && !$(chatboxtextarea).hasClass('placeholder')) {
                    ...
                    if (condition) {
                        ...
                        if (roomno != 0) {
                            ...
                            if (message != '') {
                                jqcc.cometchat.sendmessageProcess(message, roomno, this.crvariables.basedata, this.crvariables.currentroomname);
                            }
                        }
            ...
            deleteMessage: function(delid,groupid) {
                ...
                jqcc.ajax({
                    ...
                    type: "POST",
                    data: {delid:delid,currentroom:groupid, basedata:this.crvariables.basedata},
                    success: function(s) {
                        if (s == 1) {
            ...
            leaveChatroom: function(id, banflag, callbackfn) {
                ...
                jqcc.ajax({
                    url: this.crvariables.baseUrl+"modules/chatrooms/chatrooms.php?"+params,
                    data: {currentroom: id, basedata:this.crvariables.basedata},
                    type: 'post',
                    cache: false,
                    timeout: 10000,
            ...
            getGroupUsers: function(id){
                ...
                jqcc.ajax({
                    url: this.crvariables.baseUrl+"modules/chatrooms/chatrooms.php?action=getchatroomusers",
                    data: {currentroom: id,ulh: groupulh[id], basedata:this.crvariables.basedata},
                    type: 'post',
                    async:false,
                    cache: false,
                    timeout: 10000,
            ...
            checkChatroomPass: function(id,name,silent,password,clicked,type,encryptPass,force,minimized,unreadmsgcount) {
                ...
                jqcc.ajax({
                    url: this.crvariables.baseUrl+"modules/chatrooms/chatrooms.php?action=checkpassword",
                    data: {password: password, id: id, name: name, basedata:this.crvariables.basedata, silent: silent, type: type},
                    type: 'post',
                    cache: false,
                    timeout: 10000,
                    success: function(data) {
            ...
            chatroomHeartbeat: function(forceUpdate) {
                ...
                if(this.crvariables.initialize == 1){
                    ...
                    jqcc.cometchat.setChatroomVars('initialize',0);
                    /*if(jqcc.cookie(this.crvariables.cookiePrefix+'crstate') == null){
                    ...
                    if(Object.keys(chatroomData).length > 0){
                        ...
                        if(typeof(activeChatroom) != 'undefined' && activeChatroom != ''){
                            jqcc.cometchat.setChatroomVars('activeChatroom', activeChatroom);
                            jqcc.cometchat.getChatroomDetails(jqcc.cometchat.getChatroomVars('activeChatroom'),1,1);
                        }
            ...
            kickChatroomUser: function(kickid,kick,roomid){
                jqcc.ajax({
                    ...
                    type: "POST",
                    data: {kickid:kickid,currentroom:roomid,kick:kick, basedata:this.crvariables.basedata},
                    success: function(s) {
                        if (s == 1) {
            ...
            banChatroomUser: function(banid,ban,roomid){
                jqcc.ajax({
                    ...
                    type: "POST",
                    data: {banid:banid, currentroom:roomid, ban:ban, basedata:this.crvariables.basedata, popoutmode:this.crvariables.popoutmode},
                    success: function(s) {
                        if (s == 1) {
            ...
            getChatroomDetails: function(id,loadroom,force){
                var response = '';
                if(typeof(force)=='undefined'){
                    force = 0;
                }
                if(id != '') {
                    jqcc.ajax({
                        url: this.crvariables.baseUrl+"modules/chatrooms/chatrooms.php?action=getChatroomDetails",
                        data: {id: id, basedata:this.crvariables.basedata},
                        type: 'post',
                        cache: false,
                        timeout: 10000,
                        async: false,
            ...
            updateChatroomMessages: function(id,prepend){
                ...
                $.ajax({
                    cache: false,
                    url: this.crvariables.baseUrl+"modules/chatrooms/chatrooms.php?action=updateChatroomMessages",
                    data: {chatroomid: id, basedata: this.crvariables.basedata, prepend: prepend},
                    type: 'post',
                    timeout: 10000,
                    dataType: 'json',
                    success: function(data){
