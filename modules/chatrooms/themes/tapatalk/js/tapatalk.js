    ...
    $.crtapatalk = (function() {
            return {
               ...
               getTimeDisplay: function(ts,id) {
                ...
                addChatroomMessage: function(fromid,incomingmessage,incomingid,selfadded,sent,fromname,calledfromsend) {
                    ...
                    if(message != '') {
                        if ($("#cometchat_groupmessage_"+incomingid).length > 0) {
                            ...
                            if (fromid != settings.myid) {
                               ...
                               temp += ('<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'"  msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage" id="cometchat_groupmessage_'+incomingid+'"><div class="cometchat_chatboxmessagefrom"></div><div class="cometchat_messagearrow"></div>');
                               ...
                               temp += ('</strong></div><span class="chatroom_msg">'+message+'</span>'+sentdata+'</div></div>');
                                ...
                                temp += ('<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'"  msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage '+selfstyle+'" id="cometchat_groupmessage_'+incomingid+'"><div class="cometchat_chatboxmessagefrom '+selfstyle+'"></div><div class="cometchat_messagearrow"></div><div class="cometchat_chatboxmessagecontent '+selfstyle+'"><div><strong>'+fromname+':&nbsp;&nbsp;</strong></div><span class="chatroom_msg">'+message+'</span> '+sentdata+'</div></div>');
                            }
                    ...
                    if(jqcc.cometchat.getChatroomVars('owner')|| jqcc.cometchat.getChatroomVars('isModerator') || (jqcc.cometchat.getChatroomVars('allowDelete') == 1 && fromid == settings.myid)) {
                        if ($("#cometchat_groupmessage_"+incomingid).find(".delete_msg").length < 1) {
                                jqcc('#cometchat_groupmessage_'+incomingid).find('.cometchat_ts').after('<span class="delete_msg" onclick="javascript:jqcc.cometchat.confirmDelete(\''+incomingid+'\');">(<span class="hoverbraces"><?php echo $chatrooms_language[46]; ?></span>)</span>');
                        }
                ...
                loadRoom: function() {
                    ...
                    $('#currentroom_convo').attr('onscroll','jqcc.docked.chatScroll('+roomno+')');
...
jqcc.extend(jqcc.tapatalk, jqcc.crtapatalk);
